...
* `data/vardp10k.dat.gz`: pipette case, max steps 10k;
* `data/vardp100k.dat.gz`: pipette case, max steps 100k;
* `data/varrc100k.dat.gz`: pipette case, vary cut off;
* `data/poredp10k.dat.gz`: wall pore case, max steps 10k;
* `data/poredp100k.dat.gz`: wall pore case, max steps 100k;
* `data/porerc10k.dat.gz`: wall pore case, vary cut off;
