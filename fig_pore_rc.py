...
parser = argparse.ArgumentParser(description='figure S2b in supplemental')
...
ax.annotate('(b)', (2e-3, 150), fontsize=label_fs)
ax.annotate('$D_p$ = {Dp}$\,${units}'.format(Dp=Dp, units=umsqpersec), (0.4, 200), fontsize=legend_fs)
